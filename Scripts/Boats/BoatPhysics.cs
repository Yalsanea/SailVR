...
//Using Habrador's method
// his twitter @eriknordeus
    ...
    public class BoatPhysics : MonoBehaviour
    {
        ...
        void AddUnderWaterForces()
        {
           ...
           // float boatMass = VisbyData.mass; //Replace this line with your boat's total mass
            ...
            float boatMass = GetComponent<Rigidbody>().mass;
        ...
        void AddAboveWaterForces()
        {
            ...
            for (int i = 0; i < aboveWaterTriangleData.Count; i++)
            {
                ...
                forceToAdd += BoatPhysicsMath.AirResistanceForce(rhoAir, triangleData, GetComponent<Rigidbody>().drag);
